namespace SpaceInvadersALPHA
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            bonusShip = new System.Windows.Forms.Timer(components);
            explo = new PictureBox();
            label1 = new Label();
            label2 = new Label();
            shipBonus = new PictureBox();
            ...
            ((System.ComponentModel.ISupportInitialize)shipBonus).BeginInit();
            SuspendLayout();
            // 
            // hrac
            // 
            ...
            label2.TabIndex = 11;
            label2.Text = "Left/Right Arrow to MOVE, Space to SHOOT";
            // 
            // shipBonus
            // 
            shipBonus.Image = GalacticOccupiers.Properties.Resources.bonus;
            shipBonus.Location = new Point(1152, 29);
            shipBonus.Name = "shipBonus";
            shipBonus.Size = new Size(100, 50);
            shipBonus.TabIndex = 12;
            shipBonus.TabStop = false;
            // 
            // Form1
            // 
            ...
            ((System.ComponentModel.ISupportInitialize)shipBonus).EndInit();
            ResumeLayout(false);
            PerformLayout();
        }
        ...
        private System.Windows.Forms.Timer bonusShip;
        private PictureBox explo;
        private Label label1;
        private Label label2;
        private PictureBox shipBonus;
    }
}