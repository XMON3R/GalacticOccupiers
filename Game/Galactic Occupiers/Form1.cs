...
namespace SpaceInvadersALPHA
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_KeyDown_1(object sender, KeyEventArgs e)
        {
            ...
            //navíc:
            if (e.KeyCode == Keys.Escape)           //PAUZA
            {
                pauza();
            }
        ...
        ///
        private void hrac_Click(object sender, EventArgs e)         //NEDÌLÁ NIC
        {
        ...
        //ODSTRANIT PØI FINÁLNÍM ODEVZDÁNÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍ
        //label1.Text = "X position: " + hrac.Left.ToString() + " Y position: " + hrac.Top.ToString();

        //NENÍ TØEBA, ODSTRANITTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTTT
        //en.ForeColor = Color.White;
        //  en.Text = pocetEnemies.ToString();
